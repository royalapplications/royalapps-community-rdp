...
public class RdpClient9 : AxMsRdpClient8NotSafeForScripting, IRdpClient, IGatewayPaaClient
{
    /// <summary>
    ...
    /// </summary>
    private IMsRdpClientTransportSettings3 RdpTransportSettings => TransportSettings3;
