...
using RoyalApps.Community.Rdp.WinForms.Controls.Internal;
...
{
    /// <summary>
    /// Provides access to IMsRdpClientAdvancedSettings6 AdvancedSettings7
    /// </summary>
    private IMsRdpClientAdvancedSettings6 RdpAdvancedSettings => AdvancedSettings7;

    /// <summary>
    /// Provides access to IMsRdpClientNonScriptable7 GetNonScriptable7
    /// </summary>
    ...
    /// </summary>
    private IMsRdpClientTransportSettings2 RdpTransportSettings => TransportSettings2;
    ...
    public string RedirectDriveLetters
    {
        ...
        {
            field = value;
            this.SetDriveRedirection(RdpClientNonScriptable, field);
        }
    } = string.Empty;
    ...
    public void UpdateSessionDisplaySettings(uint desktopWidth, uint desktopHeight, uint physicalWidth, uint physicalHeight, uint orientation, uint desktopScaleFactor, uint deviceScaleFactor) =>
        this.LogMethodNotSupported(nameof(UpdateSessionDisplaySettings));
