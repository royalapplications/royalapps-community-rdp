...
{
    public static void ApplyRdpClientConfiguration(this RdpControl rdpControl, RdpConnectionContext connectionContext)
    {
        ...
        var effectiveSecuritySettings = connectionContext.EffectiveSecurity;
        ...
        rdpClient.DisableClickDetection = configuration.Input.DisableClickDetection;
    ...
    private static IMsRdpExtendedSettings GetCoreProperties(this IRdpClient rdpClient) =>
        (IMsRdpExtendedSettings)rdpClient.GetExtendedSettings().get_Property(RdpProperties.CoreProperties);
