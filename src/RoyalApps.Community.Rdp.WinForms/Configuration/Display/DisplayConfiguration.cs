...
public class DisplayConfiguration : ExpandableObjectConverter
{
    ...
    /// External mode writes the standard <c>use multimon</c> RDP property.
    /// In external mode, selective monitor targeting is configured through <see cref="global::RoyalApps.Community.Rdp.WinForms.Configuration.External.ExternalSessionConfiguration.SelectedMonitors"/>.
    /// </summary>
    /// <seealso>
