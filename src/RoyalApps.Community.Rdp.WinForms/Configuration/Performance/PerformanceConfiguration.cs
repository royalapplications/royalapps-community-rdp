...
public class PerformanceConfiguration : ExpandableObjectConverter
{
    ...
    /// <summary>
    /// When <see langword="true"/>, desktop wallpaper is disabled in the remote session.
    /// </summary>
    public bool DisableWallpaper { get; set; }

    /// <summary>
    /// When <see langword="true"/>, moving a window only shows its border during the drag operation.
    /// </summary>
    public bool DisableFullWindowDrag { get; set; }

    /// <summary>
    /// When <see langword="true"/>, menu animations are disabled.
    /// </summary>
    public bool DisableMenuAnimations { get; set; }

    /// <summary>
    /// When <see langword="true"/>, theming is disabled in the remote session.
    /// </summary>
    public bool DisableTheming { get; set; }

    /// <summary>
    /// When <see langword="true"/>, enhanced graphics is enabled.
    /// </summary>
    public bool EnableEnhancedGraphics { get; set; }

    /// <summary>
    /// When <see langword="true"/>, cursor shadows are disabled.
    /// </summary>
    public bool DisableCursorShadow { get; set; }

    /// <summary>
    /// When <see langword="true"/>, cursor blinking is disabled.
    /// </summary>
    public bool DisableCursorSettings { get; set; }

    /// <summary>
    /// When <see langword="true"/>, font smoothing is enabled.
    /// </summary>
    public bool EnableFontSmoothing { get; set; }

    /// <summary>
    /// When <see langword="true"/>, desktop composition is enabled.
    /// </summary>
